...
with open('C:\\z\\desarrollo\\varios\\python\\practica\\juegos\\fotoMapa\\data\\viajes.json', 'r') as f:
    datos = json.load(f)
...
with open('C:\\z\\desarrollo\\varios\\python\\practica\\juegos\\fotoMapa\\data\\fotosFinal.json', 'w') as f:
